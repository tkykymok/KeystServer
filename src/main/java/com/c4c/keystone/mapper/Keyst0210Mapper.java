...
public interface Keyst0210Mapper {
    ...
    @Insert({
        ...
        "#{pgLang,jdbcType=VARCHAR}, #{sowManagement,jdbcType=VARCHAR}, ",
        "#{sowReqDefinition,jdbcType=VARCHAR}, #{sowBasicDesign,jdbcType=VARCHAR}, ",
        "#{sowDetailDesign,jdbcType=VARCHAR}, #{sowImplementation,jdbcType=VARCHAR}, ",
        "#{sowTest,jdbcType=VARCHAR}, #{sowMaintenanceOperation,jdbcType=VARCHAR}, ",
    ...
    @Results({
        ...
        @Result(column="SOW_MANAGEMENT", property="sowManagement", jdbcType=JdbcType.VARCHAR),
        @Result(column="SOW_REQ_DEFINITION", property="sowReqDefinition", jdbcType=JdbcType.VARCHAR),
        @Result(column="SOW_BASIC_DESIGN", property="sowBasicDesign", jdbcType=JdbcType.VARCHAR),
        @Result(column="SOW_DETAIL_DESIGN", property="sowDetailDesign", jdbcType=JdbcType.VARCHAR),
        @Result(column="SOW_IMPLEMENTATION", property="sowImplementation", jdbcType=JdbcType.VARCHAR),
        @Result(column="SOW_TEST", property="sowTest", jdbcType=JdbcType.VARCHAR),
        @Result(column="SOW_MAINTENANCE_OPERATION", property="sowMaintenanceOperation", jdbcType=JdbcType.VARCHAR),
    ...
    @Update({
        ...
        "set PRJ_CODE = #{prjCode,jdbcType=VARCHAR},",
          ...
          "SOW_MANAGEMENT = #{sowManagement,jdbcType=VARCHAR},",
          "SOW_REQ_DEFINITION = #{sowReqDefinition,jdbcType=VARCHAR},",
          "SOW_BASIC_DESIGN = #{sowBasicDesign,jdbcType=VARCHAR},",
          "SOW_DETAIL_DESIGN = #{sowDetailDesign,jdbcType=VARCHAR},",
          "SOW_IMPLEMENTATION = #{sowImplementation,jdbcType=VARCHAR},",
          "SOW_TEST = #{sowTest,jdbcType=VARCHAR},",
          "SOW_MAINTENANCE_OPERATION = #{sowMaintenanceOperation,jdbcType=VARCHAR},",
