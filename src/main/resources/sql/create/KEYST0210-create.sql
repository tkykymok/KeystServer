...
(
    ...
    `OS`                        INT NULL COMMENT 'OS',
    `DB`                        INT NULL COMMENT 'DB',
    `FW_MW_TOOL`                VARCHAR(100) NULL COMMENT 'FW・MW・ツール等',
    `PG_LANG`                   VARCHAR(50) NULL COMMENT '使用言語',
    `SOW_MANAGEMENT`            INT NOT NULL DEFAULT 0 COMMENT '業務範囲_マネジメント',
    `SOW_REQ_DEFINITION`        INT NOT NULL DEFAULT 0 COMMENT '業務範囲_要件定義',
    `SOW_BASIC_DESIGN`          INT NOT NULL DEFAULT 0 COMMENT '業務範囲_基本設計',
    `SOW_DETAIL_DESIGN`         INT NOT NULL DEFAULT 0 COMMENT '業務範囲_詳細設計',
    `SOW_IMPLEMENTATION`        INT NOT NULL DEFAULT 0 COMMENT '業務範囲_実装',
    `SOW_TEST`                  INT NOT NULL DEFAULT 0 COMMENT '業務範囲_テスト',
    `SOW_MAINTENANCE_OPERATION` INT NOT NULL DEFAULT 0 COMMENT '業務範囲_保守運用',
